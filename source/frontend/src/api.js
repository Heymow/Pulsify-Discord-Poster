...
export const resetFailure = async (url) => {
  const response = await api.post('/api/channels/reset-failure', { url });
  return response.data;
};

export const addType = async (type) => {
  const response = await api.post('/api/channels/types/add', { type });
  return response.data;
};

export const removeType = async (type) => {
  const response = await api.post('/api/channels/types/remove', { type });
  return response.data;
};

export const renameType = async (oldType, newType) => {
  const response = await api.post('/api/channels/types/rename', { oldType, newType });
  return response.data;
};
